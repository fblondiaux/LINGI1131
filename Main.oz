...
% La fonction prend un point en arguement et retourne la liste des ghost sur cette case. L'etat n'est pas modifié
   ...
   % Crée un nouveau port Server, le State en arguement de server proc =
   % posPac : <pacman>#<position>|T  posG : <ghost>#<position>|T  posB :  <position>|T m: <mode> = classic|hunt ht : nombre
   % pacT : <pacman>#nombre|T gT : <ghost>#nombre|T bT : <position>#nombre|T gT : <position>#nombre|T
