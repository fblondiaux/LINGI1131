...
define
  ...
  %Ancien github pour différentes photos pacmans Ghosts https://github.com/cmomin/LINGI1131-Project/blob/master/LINGI1131Project2016/pacman/src/PacManGUI.oz
   StartWindow
   TreatStream
